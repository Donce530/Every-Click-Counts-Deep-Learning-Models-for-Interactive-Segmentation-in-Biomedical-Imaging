...
# from .focalclick_no_resize import FocalPredictor
from .focalclick_explainable import FocalPredictorExplainable
...
def get_predictor(
    ...
    elif brs_mode == 'FocalClickExplainable':
        if predictor_params is not None:
            predictor_params_.update(predictor_params)
        predictor = FocalPredictorExplainable(
            net,
            device,
            zoom_in=zoom_in,
            with_flip=with_flip,
