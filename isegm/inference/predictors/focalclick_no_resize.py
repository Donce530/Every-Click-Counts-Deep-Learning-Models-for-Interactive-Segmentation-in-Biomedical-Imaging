...
class FocalPredictor(object):
    ...
    def get_prediction(self, clicker, prev_mask=None):
        ...
        pred_logits, feature = self._get_prediction(
        ...
        y1, y2, x1, x2 = get_focus_cropv1(
            coarse_mask_np, prev_mask_np, global_roi, last_y, last_x, self.focus_crop_r
        )
