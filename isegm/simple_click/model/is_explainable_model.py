...
from isegm.simple_click.model.ops import DistMaps, BatchImageNormalize, ScaleLayer
...
class ISModel(nn.Module):
    ...
    def forward(self, image, points):
        ...
        click_map = coord_features[:, 1:, :, :]
        info['transformed_coord_features'] = coord_features
        info['transformed_click_map'] = click_map
        
        print(image.shape, coord_features.shape)
