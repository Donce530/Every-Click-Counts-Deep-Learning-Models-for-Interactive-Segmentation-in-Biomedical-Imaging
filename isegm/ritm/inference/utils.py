...
from isegm.ritm.utils.serialization import load_model
...
def get_dataset(dataset_name, cfg):
    if dataset_name == "GrabCut":
        ...
        dataset = BratsDataset(cfg.BRATS_PATH, num_channels=3)
    elif dataset_name == "LIDC_2D":
        dataset = LidcDataset(cfg.LIDC_PATH)
    elif dataset_name == "LIDC_2D_VAL":
        dataset = LidcDataset(cfg.LIDC_VAL_PATH)
    elif dataset_name == "LIDC_2D_TEST":
        dataset = LidcDataset(cfg.LIDC_TEST_PATH)
    else:
        dataset = None
