...
class DavisDataset(ISDataset):
    ...
    def get_sample(self, index) -> DSample:
        ...
        if self.init_mask_mode == 'low':
            init_mask_dir = (
                '/home/admin/workspace/project/data/datasets/DAVIS_Edit/DAVIS_low/'
            )
        elif self.init_mask_mode == 'mid':
            init_mask_dir = (
                '/home/admin/workspace/project/data/datasets/DAVIS_Edit/DAVIS_mid/'
            )
        elif self.init_mask_mode == 'high':
            init_mask_dir = (
                '/home/admin/workspace/project/data/datasets/DAVIS_Edit/DAVIS_high/'
            )
        ...
        return DSample(
            image, instances_mask, objects_ids=[1], sample_id=index, init_mask=init_mask
        )


class Davis2017Dataset(ISDataset):
    def __init__(
        self,
        dataset_path,
        ...
        **kwargs
        ...
        super(Davis2017Dataset, self).__init__(**kwargs)
        self.name = 'Davis2017'
        self.dataset_path = Path(dataset_path)
        self._images_path = self.dataset_path / images_dir_name
        self._insts_path = self.dataset_path / masks_dir_name
