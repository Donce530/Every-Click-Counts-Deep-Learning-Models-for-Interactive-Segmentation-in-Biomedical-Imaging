...
class MultiPointSampler(BasePointSampler):
    ...
    def sample_points(self):
        ...
        # return pos_points + [[-1, -1, -1] for _ in range(len(pos_points))]
    ...
    def _multi_mask_sample_points(self, selected_masks, is_negative, with_first_click=False):
        ...
        if len(points) < self.max_num_points:
            points.extend([(-1, -1, -1, 5)] * (self.max_num_points - len(points)))
    ...
    def _sample_points(self, mask, is_negative=False, with_first_click=False):
        ...
        for j in range(num_points):
            ...
            if num_indices > 0:
                ...
                click = point_indices[np.random.randint(0, num_indices)].tolist() + [point_indx, 5] # default point size
                points.append(click)
