...
from isegm.ritm.data.transforms import UniformRandomResize
...
from isegm.ritm.inference.utils import find_checkpoint, load_is_model
...
def init_model(cfg, device):
    ...
    model_cfg.name = model_cfg.name = f'{MODEL_NAME}{windowing_suffix}'
...
def configure_datasets(cfg, model_cfg):
    ...
    elif cfg.standard_augmentations.enabled:
        # crop_size = (320, 480)
        crop_size = (512,512)
