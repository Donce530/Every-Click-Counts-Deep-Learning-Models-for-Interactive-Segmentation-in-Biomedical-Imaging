...
def init_model(cfg, device):
    ...
    if cfg.use_pretrained_weights:
        ...
        checkpoint_path = find_checkpoint(
            cfg.data_paths.INTERACTIVE_MODELS_PATH,
            'author_pretrained_segformerB3_combined',
        )
        ...
        model.feature_extractor.load_pretrained_weights(
            cfg.data_paths.IMAGENET_PRETRAINED_MODELS.SEGFORMER_B3
        )
